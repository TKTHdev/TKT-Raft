...
func (r *Raft) doFollower() error {
	...
	case <-timer.C:
		//election timeout
		r.logPut("Haven't received heartbeat, starting election")
		r.startElection()
	case <-r.heartBeatCh:
		r.logPut("Received heartbeat, resetting election timer")
		//received heartbeat
	}
	return nil
}
